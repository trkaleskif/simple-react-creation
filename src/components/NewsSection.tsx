...
const NewsSection = () => {
  ...
  const recentNews = [
    "New MATTE finish available for all handles",
    "New exhibition in our Milan showroom",
    "Meet our design team in Paris next month"
  ];
    ...
    <section id="news" className="py-16 lg:py-24 bg-cream">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <a href="#" className="inline-flex items-center space-x-2 mt-4 md:mt-0">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            {news.map((item, index) => (
              <div key={index} className="group">
                ...
                <a href="#" className="text-sm fancy-hover-effect inline-block mt-2">Read more</a>
              </div>
            ))}
          </div>
